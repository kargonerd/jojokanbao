...
- `legacy-jiuwen-root/`：来自 `C:\Users\luoxixi\GAI\jojojiuwen` 根目录的 docs、demo、docker 和辅助脚本归档。当前 Olds Web 模块在 `frontend/web/src/olds`，移动端位于 `frontend/mobile`，未上线 API 位于 `backend/src/app/olds`。
