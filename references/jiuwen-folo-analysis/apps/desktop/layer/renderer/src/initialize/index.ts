...
import { startEntityExtractionScheduler } from "~/modules/entity-extraction"
...
export const initializeApp = async () => {
  ...
  // 启动实体抽取定时任务
  apm("startEntityExtractionScheduler", () => {
    startEntityExtractionScheduler(60000) // 每分钟检查一次待处理任务
  })
