...
invitation redemption, annotation privacy with a database-fixed disclosure
threshold, and AI usage/lease enforcement. Supabase CI also runs the pgTAP suite
against PostgreSQL.
