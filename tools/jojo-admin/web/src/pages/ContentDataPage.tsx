...
export function ContentDataPage() {
  ...
  return <>
    <PageTopbar eyebrow="Content Pipeline / v1" title="书籍与内容" description="微信读书 / EPUB / Kindle → Hugging Face Canonical → B2 Delivery" />
    <main className="content-workbench">
      ...
      {canPublish && publishers && <section className="workspace-panel content-publish-panel">
        <div className="section-heading"><span>02</span><div><h2>发布生成结果</h2><p>Hugging Face 是唯一 Canonical 真值；B2 只保存 Reader 使用的 Delivery。ES 由统一同步器从 HF 重建。</p></div></div>
