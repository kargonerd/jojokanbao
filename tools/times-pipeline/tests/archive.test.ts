...
describe("page capture orchestration", () => {
  ...
  it("marks a retained, rediscovered FT page for recovery after the terminal extractor revision", () => {
    ...
    const previous = {
      ...
      captureRevision: "semantic-html-media-v2+ft-body-assets-v2",
    };
    const current = {
      ...previous,
    ...
    expect(ftFetch.revision).toBe("ft-body-assets-v3");
