...
describe("page capture orchestration", () => {
  ...
  it("marks a retained, rediscovered FT page for recovery after the hardened extractor revision", () => {
    ...
    const previous = {
      ...
      captureRevision: "semantic-html-media-v2+ft-body-assets-v1",
    };
    const current = {
      ...previous,
    ...
    expect(ftFetch.revision).toBe("ft-body-assets-v2");
