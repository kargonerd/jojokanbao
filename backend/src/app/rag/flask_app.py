...
try:
    ...
    try:
        from app.rag.admin import admin_bp
        app.register_blueprint(admin_bp)
...
try:
    ...
    try:
        from app.rag.person_api import person_bp
        app.register_blueprint(person_bp)
    except ImportError as e2:
...
try:
    ...
    try:
        from app.rag.catalog_api import catalog_bp
        app.register_blueprint(catalog_bp)
    except ImportError as e2:
...
try:
    ...
    try:
        from app.rag.section_analyzer import section_bp
        app.register_blueprint(section_bp)
    except ImportError as e2:
...
def list_notebooks():
    ...
    try:
        try:
            ...
            from app.rag.notebook_service import list_catalog_notebooks
...
async def get_client_for_notebook(notebook_id):
    ...
    try:
        ...
        from app.rag.notebook_service import get_client_for_notebook_async
...
def list_sources(notebook_id):
    try:
        try:
            ...
            from app.rag.notebook_service import sync_notebook_sources
...
def get_source(notebook_id, source_id):
    try:
        try:
            ...
            from app.rag.notebook_service import get_source_record
...
def get_source_fulltext(notebook_id, source_id):
    try:
        try:
            ...
            from app.rag.notebook_service import get_source_document_text
