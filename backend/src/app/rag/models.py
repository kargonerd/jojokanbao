...
class LibraryManager:
    ...
    def _get_cos(cls):
        try:
            ...
            from app.rag.cos_manager import get_cos_manager
    ...
    def _get_dbm(cls):
        try:
            ...
            from app.rag.database import LibraryDBManager
...
class BookManager:
    ...
    def _get_dbm(cls):
        try:
            ...
            from app.rag.database import BookDBManager
...
class HighlightManager:
    ...
    def __init__(self):
        try:
            ...
            from app.rag.cos_manager import get_cos_manager, get_highlights_key
