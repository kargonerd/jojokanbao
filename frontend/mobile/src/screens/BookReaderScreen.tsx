      ...
      {chromeVisible ? <>
        ...
        {activeTool === "ai" ? <View style={[styles.toolSheet, styles.fullSheet, { top: insets.top + 64, bottom: sheetBottom, borderColor: theme.ruleDark, backgroundColor: theme.paper }]}>
          <AiPanelHeader
            ...
            theme={theme}
          />
          <View accessibilityRole="summary" style={[styles.aiBetaNotice, { borderLeftColor: theme.red, backgroundColor: theme.paper }]}><Text style={[styles.aiBetaBadge, { color: theme.red, borderColor: theme.red, fontFamily: theme.sans }]}>Beta</Text><Text style={[styles.aiBetaText, { color: theme.ink, fontFamily: theme.sans }]}>实验功能：回答可能不准确、遗漏或误解原文，请结合引用内容核对。</Text></View>
          <>
        ...
        <View style={[styles.toolbar, { bottom: insets.bottom, borderTopColor: theme.ruleDark, backgroundColor: theme.paper }]}>{([
          ...
          { id: "ai" as const, label: "AI", icon: "sparkles-outline" as const, beta: true },
...
function SelectionAction({ label, beta = false, icon, theme, onPress }: { label: string; beta?: boolean; icon: keyof typeof Ionicons.glyphMap; theme: MobileTheme; onPress: () => void }) {
  return <Pressable onPress={onPress} style={styles.selectionAction}><Ionicons name={icon} size={18} color={theme.ink} /><View style={styles.selectionActionLabel}><Text style={[styles.selectionActionText, { color: theme.ink, fontFamily: theme.sans }]}>{label}</Text>{beta ? <Text style={[styles.selectionActionBeta, { color: theme.red, fontFamily: theme.sans }]}>Beta</Text> : null}</View></Pressable>;
}
...
const styles = StyleSheet.create({
  ...
  toolbar: { position: "absolute", zIndex: 4, left: 0, right: 0, minHeight: 64, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: "row", alignItems: "stretch", paddingHorizontal: 3 }, toolButton: { flex: 1, minHeight: 58, alignItems: "center", justifyContent: "center", gap: 3 }, toolLabelAnchor: { position: "relative" }, toolText: { fontSize: 9, fontWeight: "800" }, toolBeta: { position: "absolute", left: "100%", top: -4, marginLeft: 1, fontSize: 5, fontWeight: "800", lineHeight: 6 },
  ...
  aiPanelHeader: { minHeight: 62, marginHorizontal: 18, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: "row", alignItems: "center", gap: 14 }, aiPanelHeading: { flex: 1, minWidth: 0 }, aiPanelTitleAnchor: { position: "relative", alignSelf: "flex-start" }, aiPanelTitle: { fontSize: 16, fontWeight: "900" }, aiPanelTitleBeta: { position: "absolute", left: "100%", top: -3, marginLeft: 3, fontSize: 6, fontWeight: "800", lineHeight: 7 }, aiPanelBook: { marginTop: 3, fontSize: 8, fontWeight: "700" }, aiNewConversation: { fontSize: 10, fontWeight: "900" }, aiBetaNotice: { marginHorizontal: 18, marginTop: 12, borderLeftWidth: 2, paddingHorizontal: 10, paddingVertical: 8, flexDirection: "row", alignItems: "flex-start", gap: 8 }, aiBetaBadge: { borderWidth: 1, paddingHorizontal: 4, paddingVertical: 1, fontSize: 7, fontWeight: "900", lineHeight: 9, textTransform: "uppercase" }, aiBetaText: { flex: 1, fontSize: 9, fontWeight: "700", lineHeight: 16 },
  ...
  selectionBar: { position: "absolute", zIndex: 7, alignSelf: "center", minWidth: 250, borderWidth: 1, flexDirection: "row", paddingHorizontal: 5 }, selectionAction: { minWidth: 60, height: 54, alignItems: "center", justifyContent: "center", gap: 3 }, selectionActionLabel: { position: "relative" }, selectionActionText: { fontSize: 9, fontWeight: "800" }, selectionActionBeta: { position: "absolute", left: "100%", top: -4, marginLeft: 1, fontSize: 5, fontWeight: "800", lineHeight: 6 },
