...
import type { PdfSearchResult } from "../../packages/pdf-viewer/src/searchText";
...
describe("outline-first PDF positioning", () => {
  it("positions using the bookmark before text results and never recenters on a later text match", async () => {
