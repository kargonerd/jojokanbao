    ...
    <AppShell
      sidebar={
        ...
        <nav className="space-y-1">
          <NavLink to="/rag/admin/accounts" className={({ isActive }) => `block px-3 py-2 text-sm font-bold no-underline ${isActive ? "text-red" : "text-ink hover:text-red"}`}>账号管理</NavLink>
          <NavLink to="/rag/admin/libraries" className={({ isActive }) => `block px-3 py-2 text-sm font-bold no-underline ${isActive ? "text-red" : "text-ink hover:text-red"}`}>知识库</NavLink>
        </nav>
