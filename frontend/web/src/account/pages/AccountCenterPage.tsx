        ...
        <div className="border-y border-rule">
          ...
          <section aria-labelledby="reader-links-title" className="grid gap-4 border-t border-rule py-6 sm:grid-cols-[11rem_minmax(0,1fr)] sm:gap-8">
            ...
            <nav aria-label="我的快捷入口" className="divide-y divide-rule border-y border-rule">
              ...
              <Link to="/donate" className={accountLinkClass}><span>支持我们</span><span aria-hidden="true">→</span></Link>
          ...
          <section aria-labelledby="reading-preferences-title" className="grid gap-4 border-t border-rule py-6 sm:grid-cols-[11rem_minmax(0,1fr)] sm:gap-8">
            ...
            <div className="border-y border-rule">
              ...
              <Link to="/account/library" className="flex items-center justify-between gap-5 border-t border-rule py-4 text-ink hover:text-red focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-red">
                <div>
                  <h3 className="m-0 font-serif text-base font-black">资料库设置</h3>
                  <p className="mb-0 mt-1 text-xs font-bold leading-6 text-muted">选择在资料库中显示的书源。</p>
                </div>
